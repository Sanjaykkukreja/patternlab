...
let CS_PATTERNS = [
  ...
  {id:"P10",name:"Excentre",trigger:"Asked for the excentre opposite a specific vertex (the circle tangent to one side and to the extensions of the other two).",move:"I_A=((\u2212a\u00b7x\u2081+b\u00b7x\u2082+c\u00b7x\u2083)/(\u2212a+b+c), ...) \u2014 same weights as the incentre but negate only the coefficient of the vertex whose opposite excentre is wanted.",why:"The excentre opposite A sits on the external bisectors of B and C but the internal bisector of A; flipping the sign of a (side opposite A) captures that internal/external switch algebraically.",mini:"Find the excentre opposite vertex A of the triangle (2,3),(1,1),(0,4).",fails:"Negating the wrong side's coefficient \u2014 excentre opposite A negates 'a' (side BC, opposite A), not the label x\u2081 itself.",src:"Illus 1.42",srcText:{"Illus 1.42":"Find the coordinates of the incentre and all the excentres of the triangle whose vertices are (1,1),(4,1),(1,5)."}},
...
let CS_GUIDED = [
  {id:"G1",tier:3,tax:"P1",pattern:"P1",q:"If the origin is shifted to (1,\u22122) without rotation of the axes, what does the equation y\u00b2\u22124x+4y+8=0 become in the new coordinates?",
    opts:["Translation of Axes","Rotation of Axes","Section Formula","Locus \u2014 Direct Condition"],correct:0,
    hints:["Substitute x=X+1, y=Y\u22122 directly into the equation and expand every term.","Collect like terms in X and Y \u2014 watch the constant contributions from expanding (Y\u22122)\u00b2 and 4(Y\u22122).","The linear-Y and constant pieces should cancel completely, leaving a clean relation between Y\u00b2 and X."],
    ans:"Y\u00b2 = 4X",why:"Substituting the given translation and collecting terms shows the linear-Y and constant parts cancel exactly \u2014 that's the whole point of choosing THIS particular new origin."},
  {id:"G2",tier:3,tax:"P2",pattern:"P2",q:"The axes are rotated through an angle of \u03c0/3 in the anticlockwise direction about (0,0). Find the coordinates of the point (4,2), given w.r.t. the OLD axes, in the new coordinate system.",
    opts:["Rotation of Axes","Translation of Axes","Slope & Angle Between Lines","Polar \u2194 Cartesian Conversion"],correct:0,
    hints:["Old-to-new needs the REVERSE table: X=xcos\u03b8+ysin\u03b8, Y=\u2212xsin\u03b8+ycos\u03b8 (not the old-in-terms-of-new one).","With \u03b8=\u03c0/3: X=4cos60\u00b0+2sin60\u00b0.","Y=\u22124sin60\u00b0+2cos60\u00b0. Simplify each using cos60\u00b0=1/2, sin60\u00b0=\u221a3/2."],
    ans:"(X,Y) = (2+\u221a3, 1\u22122\u221a3)",why:"Converting old coordinates to new (rather than the other way) uses the reverse conversion table \u2014 mixing up the two tables is the single most common slip in rotation problems."},
  ...
  {id:"G4",tier:3,tax:"P4",pattern:"P4",q:"Find y so that the point (2,y) is equidistant from (3,7) and (\u22123,5).",
    opts:["Distance Formula","Section Formula","Area of Triangle/Polygon","Slope & Angle Between Lines"],correct:0,
    hints:["Set (distance to (3,7))\u00b2 = (distance to (\u22123,5))\u00b2 and expand both sides using the distance formula.","(2\u22123)\u00b2+(y\u22127)\u00b2 = (2+3)\u00b2+(y\u22125)\u00b2 \u21d2 1+y\u00b2\u221214y+49 = 25+y\u00b2\u221210y+25.","The y\u00b2 terms cancel \u2014 solve the remaining linear equation in y."],
    ans:"y = 0",why:"Squaring an equidistance condition and cancelling the y\u00b2 terms turns 'equidistant from two points' into one clean linear equation \u2014 the algebraic version of finding a point on the perpendicular bisector."},
  ...
  {id:"G6",tier:3,tax:"P6",pattern:"P6",q:"Find the area of the triangle with vertices A(3,2), B(11,8), C(8,12).",
    opts:["Area of Triangle/Polygon (Shoelace)","Collinearity via Area=0","Section Formula","Locus \u2014 Direct Condition"],correct:0,
    hints:["Apply \u0394=\u00bd|x\u2081(y\u2082\u2212y\u2083)+x\u2082(y\u2083\u2212y\u2081)+x\u2083(y\u2081\u2212y\u2082)| directly.","Substitute: \u00bd|3(8\u221212)+11(12\u22122)+8(2\u22128)|.","Simplify inside the modulus: 3(\u22124)+11(10)+8(\u22126) = \u221212+110\u221248."],
    ans:"Area = 25 sq. units",why:"One pass through the determinant handles any triangle directly \u2014 no need to hunt for a convenient base and height."},
  {id:"G7",tier:3,tax:"P7",pattern:"P7",q:"Find the value of p so that the points (p,\u22121), (2,1), (4,5) are collinear.",
    opts:["Collinearity via Area=0","Section Formula","Slope & Angle Between Lines","Area of Triangle/Polygon"],correct:0,
    hints:["Two of the three points, (2,1) and (4,5), are fully known \u2014 compute the slope between them first.","Slope(2,1)\u2192(4,5) = (5\u22121)/(4\u22122) = 2. Collinearity means the slope from (p,\u22121) to (2,1) must equal this same value.","(1\u2212(\u22121))/(2\u2212p) = 2 \u21d2 2/(2\u2212p) = 2 \u21d2 solve for p."],
    ans:"p = 1",why:"When two of three points are fully known, computing their slope first turns a collinearity question into a single linear equation \u2014 faster than the full area-determinant expansion."},
  {id:"G8",tier:3,tax:"P8",pattern:"P8",q:"Find the centroid of the triangle with vertices (2,4), (6,\u22122), (\u22122,\u22122).",
    opts:["Centroid","Incentre","Circumcentre & Orthocentre","Euler Line"],correct:0,
    hints:["With all three vertices given directly, the centroid is just their average \u2014 no median or section-formula work needed.","Average the x-coordinates: (2+6\u22122)/3.","Average the y-coordinates: (4\u22122\u22122)/3."],
    ans:"Centroid = (2, 0)",why:"When every vertex is known, the centroid is a one-line average \u2014 save the section-formula inversion for when a vertex or the centroid itself is the unknown being asked for."},
  {id:"G9",tier:3,tax:"P9",pattern:"P9",q:"Find the incentre of the right triangle with vertices A(0,0), B(5,0), C(0,12).",
    opts:["Incentre","Excentre","Centroid","Circumcentre & Orthocentre"],correct:0,
    hints:["Find the side lengths opposite each vertex: a=BC, b=CA, c=AB.","BC=\u221a(5\u00b2+12\u00b2)=13 (opposite A); CA=12 (opposite B, the vertical leg); AB=5 (opposite C, the horizontal leg).","Incentre = (a\u00b7A+b\u00b7B+c\u00b7C)/(a+b+c) = (13\u00b7(0,0)+12\u00b7(5,0)+5\u00b7(0,12))/30."],
    ans:"Incentre I = (2, 2)",why:"The classic 5-12-13 right triangle is a good sanity-check case \u2014 for ANY right triangle with legs p,q and hypotenuse r, the inradius (and hence each incentre coordinate here) works out to (p+q\u2212r)/2 = (5+12\u221213)/2 = 2."},
  {id:"G10",tier:3,tax:"P10",pattern:"P10",q:"For the same right triangle A(0,0), B(5,0), C(0,12) (a=BC=13, b=CA=12, c=AB=5), find the excentre opposite vertex A.",
    opts:["Excentre","Incentre","Centroid","Euler Line"],correct:0,
    hints:["Start from the incentre formula but negate the coefficient of vertex A \u2014 that means negate 'a', the side opposite A.","I_A = (\u2212a\u00b7A+b\u00b7B+c\u00b7C)/(\u2212a+b+c) = (\u221213\u00b7(0,0)+12\u00b7(5,0)+5\u00b7(0,12))/(\u221213+12+5).","Compute the denominator first (\u221213+12+5=4), then each coordinate."],
    ans:"Excentre opposite A, I_A = (15, 15)",why:"Same triangle as the incentre card, one sign flipped \u2014 a clean way to see that the incentre and excentre formulas are really the same formula with a single choice of sign."},
  ...
  {id:"G12",tier:3,tax:"P12",pattern:"P12",q:"The circumcentre of a triangle lies at the origin and its centroid is the midpoint of the segment joining (a\u00b2+1, a\u00b2+1) and (2a, \u22122a). Find the orthocentre in terms of a.",
    opts:["Euler Line","Circumcentre & Orthocentre","Centroid","Section Formula"],correct:0,
    hints:["First find the centroid: G = midpoint = ((a\u00b2+1+2a)/2, (a\u00b2+1\u22122a)/2) = ((a+1)\u00b2/2, (a\u22121)\u00b2/2).","Since the circumcentre O is the origin, the Euler-line relation H=3G\u22122O collapses to H=3G.","Multiply each coordinate of G by 3."],
    ans:"Orthocentre H = (3(a+1)\u00b2/2, 3(a\u22121)\u00b2/2)",why:"With O pinned at the origin, the general H=3G\u22122O relation simplifies to its cleanest possible form, H=3G \u2014 always check for O=origin as a shortcut before grinding through the full relation."},
  {id:"G13",tier:3,tax:"P13",pattern:"P13",q:"If A(\u22122,1), B(2,3), C(\u22122,\u22124) are three points, find the angle between BA and BC.",
    opts:["Slope & Angle Between Lines","Rotation of Axes","Locus \u2014 Direct Condition","Section Formula"],correct:0,
    hints:["Find the slope of BA: m\u2081=(1\u22123)/(\u22122\u22122).","Find the slope of BC: m\u2082=(\u22124\u22123)/(\u22122\u22122).","Apply tan\u03b8=|(m\u2082\u2212m\u2081)/(1+m\u2081m\u2082)| with m\u2081=1/2, m\u2082=7/4."],
    ans:"\u03b8 = tan\u207b\u00b9(2/3)",why:"Both slopes come from the SAME vertex B here (not a line-vs-equation setup) \u2014 the angle formula doesn't care, as long as you're consistent about which slope is m\u2081 and which is m\u2082."},
  {id:"G14",tier:3,tax:"P14",pattern:"P14",q:"Find the equation of the locus of a point such that the sum of its distances from (0,2) and (0,\u22122) is 6.",
    opts:["Locus \u2014 Direct Condition","Locus \u2014 Parameter Elimination","Distance Formula","Section Formula"],correct:0,
    hints:["Let the moving point be (h,k). Recognise (0,2) and (0,\u22122) as two fixed points 2c apart with 2a=6 \u2014 this is exactly the defining property of an ellipse.","So a=3 and c=2 (half the focus-separation), giving b\u00b2=a\u00b2\u2212c\u00b2=9\u22124=5.","Since the foci lie on the y-axis, the standard form is x\u00b2/b\u00b2+y\u00b2/a\u00b2=1."],
    ans:"Locus: x\u00b2/5 + y\u00b2/9 = 1",why:"'Sum of distances from two fixed points = constant' IS the defining property of an ellipse \u2014 recognising that skips the full radical-clearing algebra entirely."},
  {id:"G15",tier:3,tax:"P15",pattern:"P15",q:"If the coordinates of a variable point P are (a cos\u03b8, b sin\u03b8), where \u03b8 is a variable quantity, find the equation of the locus of P.",
    opts:["Locus \u2014 Parameter Elimination","Locus \u2014 Direct Condition","Rotation of Axes","Polar \u2194 Cartesian Conversion"],correct:0,
    hints:["Write x=a cos\u03b8, y=b sin\u03b8, i.e. cos\u03b8=x/a and sin\u03b8=y/b.","You need an identity connecting cos\u03b8 and sin\u03b8 that's true for EVERY \u03b8 \u2014 that's cos\u00b2\u03b8+sin\u00b2\u03b8=1.","Substitute the two isolated ratios into that identity."],
    ans:"Locus: x\u00b2/a\u00b2 + y\u00b2/b\u00b2 = 1",why:"When the parameter sits inside sin and cos separately, isolate each ratio first (divide by a, by b) THEN invoke cos\u00b2+sin\u00b2=1 \u2014 skipping the isolation step is the most common mistake in this pattern."}
];
